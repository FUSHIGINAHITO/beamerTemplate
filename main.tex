...
\definecolor{color2}{RGB}{135, 197, 237}%theorem
\definecolor{color3}{RGB}{241, 182, 194}%def
\definecolor{color4}{RGB}{197, 224, 169}%proof
\definecolor{color5}{RGB}{222, 32, 120}%emph
\definecolor{color6}{RGB}{233, 203, 153}%example
...
\makeatletter
\renewtcolorbox[use counter=myproofcut,number within=section]{myproofcut}[2][]{
  title={Proof\ #2},
  colback=color4!0!white,
  colframe=color4,
...
\makeatletter
\renewtcolorbox[use counter=myproof,number within=section]{myproof}[2][]{
  title={Proof\ #2},
  colback=color4!0!white,
  colframe=color4,
  fonttitle=\fontfamily{bch}\selectfont\bfseries,
...
\makeatletter
\renewtcolorbox[use counter=mysol,number within=section]{mysol}[2][]{
  title={Solution\ #2},
  colback=color4!0!white,
  colframe=color4,
  fonttitle=\fontfamily{bch}\selectfont\bfseries,
...
\makeatletter
\renewtcolorbox[use counter=mydef,number within=section]{mydef}[2][]{
  title={Definition \themydef\ #2},
  colback=color3!0!white,
  colframe=color3,
  fonttitle=\fontfamily{bch}\selectfont\bfseries,
  #1
}
...
\makeatletter
\renewtcolorbox[use counter=mythm,number within=section]{mythm}[2][]{
  title={Theorem \themythm\ #2},
  colback=color2!0!white,
  colframe=color2,
  fonttitle=\fontfamily{bch}\selectfont\bfseries,
  #1
}
...
\makeatletter
\renewtcolorbox[use counter=mylem,number within=section]{mylem}[2][]{
  title={Lemma \themylem\ #2},
  colback=color2!0!white,
  colframe=color2,
  fonttitle=\fontfamily{bch}\selectfont\bfseries,
  #1
...
\makeatletter
\renewtcolorbox[use counter=mycol,number within=section]{mycol}[2][]{
  title={Corollary \themycol\ #2},
  colback=color2!0!white,
  colframe=color2,
  fonttitle=\fontfamily{bch}\selectfont\bfseries,
  #1
...
\makeatletter
\renewtcolorbox[use counter=myfact,number within=section]{myfact}[2][]{
  title={Fact \themyfact\ #2},
  colback=color2!0!white,
  colframe=color2,
  fonttitle=\fontfamily{bch}\selectfont\bfseries,
  #1
...
\makeatletter
\renewtcolorbox[use counter=mypro,number within=section]{mypro}[2][]{
  title={Proposition \themypro\ #2},
  colback=color2!0!white,
  colframe=color2,
  fonttitle=\fontfamily{bch}\selectfont\bfseries,
  #1
...
\makeatletter
\renewtcolorbox[use counter=mycon,number within=section]{mycon}[2][]{
  title={Conjecture \themycon\ #2},
  colback=color2!0!white,
  colframe=color2,
  fonttitle=\fontfamily{bch}\selectfont\bfseries,
  #1
...
\makeatletter
\renewtcolorbox[use counter=myclaim,number within=section]{myclaim}[2][]{
  title={Claim \themyclaim\ #2},
  colback=color2!0!white,
  colframe=color2,
  fonttitle=\fontfamily{bch}\selectfont\bfseries,
  #1
...
\makeatletter
\renewtcolorbox[use counter=myexa,number within=section]{myexa}[2][]{
  title={Example \themyexa\ #2},
  colback=color6!0!white,
  colframe=color6,
  fonttitle=\fontfamily{bch}\selectfont\bfseries,
  #1
}
...
\makeatletter
\renewtcolorbox[use counter=myrem,number within=section]{myrem}[2][]{
  title={Remark \themyrem\ #2},
  colback=color6!0!white,
  colframe=color6,
  fonttitle=\fontfamily{bch}\selectfont\bfseries,
  #1
...
% 修改item样式
\setbeamertemplate{itemize item}{\raisebox{.4\height}{\color{color5}\tiny\faSunO}}
\setbeamertemplate{itemize subitem}{\raisebox{.4\height}{\color{color5}\tiny\faMoonO}}
\setbeamertemplate{itemize subsubitem}{\raisebox{.4\height}{\color{color5}\tiny\faStarO}}
...
\newcommand{\myref}[1]{{\color{color5}[\ref{#1}]}}
\newcommand{\myreff}[1]{{[\ref{#1}]}}
