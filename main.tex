...
% 修改item样式
\setbeamertemplate{itemize item}{$\color{color5}\clubsuit$}
\setbeamertemplate{itemize subitem}{$\color{color5}\diamondsuit$}
\setbeamertemplate{itemize subsubitem}{$\color{color5}\spadesuit$}
